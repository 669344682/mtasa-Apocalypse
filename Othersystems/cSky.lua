...
--((Developers: DorteY & Ren712))
--((File: Othersystems/cSky.lua))
...
function startDynamicSky()
	...
	shaderTable.skyboxTropos = dxCreateShader ( "Files/Models/shader_dynamicSky2tropos.fx", 2, 0, false, "object" )
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxStratos = dxCreateShader ( "Files/Models/shader_dynamicSky2up.fx", 2, 0, false, "object" ) 
	    else shaderTable.skyboxStratos = dxCreateShader ( "Files/Models/shader_dynamicSky2stratos.fx", 2, 0, false, "object" ) end
	if dynamicSkySettings.stratosBottomStars then shaderTable.skyboxBottom = dxCreateShader ( "Files/Models/shader_dynamicSky2down.fx", 3, 0, false, "object" )
		else shaderTable.skyboxBottom = dxCreateShader ( "Files/Models/shader_dynamicSky2bottom.fx", 3, 0, false, "object" ) end
	shaderTable.clear = dxCreateShader ( "Files/Models/shader_clear.fx", 3, 0, false, "world" )
	textureTable.cloud = dxCreateTexture ( "Files/Images/Sky/Clouds.dds", "dxt5" )
	textureTable.normal = dxCreateTexture ( "Files/Images/Sky/CloudsNormal.jpg", "dxt5" ) 
	textureTable.skybox = dxCreateTexture ( "Files/Images/Sky/Skybox.dds", "dxt5" )
	moonPhase = getCurrentMoonPhase()
	textureTable.moon = dxCreateTexture ( "Files/Images/Sky/Moon/"..toint( 20 - toint( moonPhase * 20 ) )..".png" )
	...
	modelTable.txd = engineLoadTXD( 'Files/Models/Sky.txd' )
	engineImportTXD( modelTable.txd, dynamicSkySettings.modelID)
	modelTable.dff = engineLoadDFF( 'Files/Models/Sky.dff', dynamicSkySettings.modelID )
